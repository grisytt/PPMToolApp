...
public class FindProjectByIdentifierTest {
    // find the project successfully
    @Autowired
    ...
    @Test
    public void findProjectByIdentifierTest() {
        projectService.findByProjectIdentifier("junit", "testUser@email.com");
    }
