...
public class FindBacklogByIdentifierTest {
    ...
    public void preCreate() {
        ...
        projectTask.setSummary("Find project tasks by backlog's identifier");
    ...
    @Test
    public void findBacklogByIdentifierTest() {
        projectTaskService.findBacklogById("junit", "testUser@email.com");
    }
