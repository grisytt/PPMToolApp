...
public class FindProjectTaskBySequenceTest {
    ...
    @Test
    public void findProjectTaskBySequenceTest() {
        projectTaskService.findPTByProjectSequence("junit","JUNIT-1" , "testUser@email.com");
    }
